...
⚠️ Logo 处理规则（极其重要）：
- 如果用户要求"加上公司logo"或"加上logo"，必须在 prompt 中明确写出公司品牌名 Enbon
- Logo 位置：优先放在 LED 屏幕右下角显示区域，或产品机身显眼位置
- 描述要具体：如 "the Enbon logo in white text displayed at the bottom right corner of the LED screen"
- 如果参考图中有 logo 图片，在 prompt 中说明参考其样式
- 不要把 logo 藏在不起眼的角落（如包装箱、背景），要放在产品主体可见位置
